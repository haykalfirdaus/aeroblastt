...
export const RANK_DURATION_OPTIONS = [
  { id: 'monthly', label: '1 Bulan', sub: 'Akses Sementara', percentOfBase: 50, isDefault: false },
  { id: 'quarterly', label: '3 Bulan', sub: 'Akses Sementara', percentOfBase: 80, isDefault: false },

...
export const COMMANDS = [
  ...
  },
  {
    ...
    accent: 'cmd-blue',
    basePrice: 25000,
    description: 'Ubah cuaca server sesukamu — cerah atau hujan kapan saja.',
    orderLabel: '/weather — WEATHER',
  },
  {
    key: 'TIME',
    name: 'Time',
    ...
    accent: 'cmd-gold',
    basePrice: 25000,
    description: 'Atur waktu server — siang atau malam sesuai kebutuhanmu.',
    orderLabel: '/time — TIME',
  },
  {
    key: 'UTILITY',
    name: 'Utility Pack',

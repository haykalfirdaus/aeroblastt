  ...
  return (
    <PageLayout>
      ...
      <div className="relative border-b border-[#D8D1C0] bg-[#EDE8DA] px-4 py-10 text-center sm:px-6 lg:px-8">
        ...
        <span className="relative mb-3 inline-flex items-center gap-1.5 rounded-full border border-warning/30 bg-warning/8 px-3 py-1 font-mono text-[0.65rem] font-semibold uppercase tracking-[0.14em] text-warning">
          <Trophy size={11} /> Top Voters Bulan Ini
        </span>
        <h1 className="relative font-display text-2xl font-extrabold text-[#1A2E1A] sm:text-3xl">
          Leaderboard Voter
        </h1>
        <p className="relative mt-1.5 text-xs text-[#6B7F5A]">Vote setiap hari dan menangkan reward eksklusif!</p>
      </div>
      ...
      <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section className="mb-10">
          <h2 className="mb-4 inline-flex items-center gap-2 font-display text-base font-bold text-[#1A2E1A]">
        ...
        {status === 'success' && voters.length >= 3 && (
          <section className="mb-8">
            <h2 className="mb-5 flex items-center justify-center gap-2 font-display text-base font-bold text-[#1A2E1A]">
        ...
        {/* Vote CTA */}
        <div className="mt-8 flex flex-col items-center gap-3 rounded-2xl border border-[#B4E035]/25 bg-[#B4E035]/[0.07] px-5 py-7 text-center">

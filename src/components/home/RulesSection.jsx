              ...
              <GlassCard key={cat.title}>
                <div className="p-4">
                  <div className="mb-3 flex items-center gap-2">
                    <CatIcon size={15} className="text-neon-400 shrink-0" />
                    <h3 className="font-display text-sm font-bold text-text-bright">{cat.title}</h3>
                  </div>
                  ...
                  <ul className="mb-3 flex flex-col gap-2.5">
                    {cat.points.map((pt) => (
                      <li key={pt.label} className="flex items-start gap-2">
                        ...
                        <div>
                          <span className="text-[0.7rem] font-bold text-text-bright">{pt.label}: </span>
                          <span className="text-[0.7rem] text-text-muted">{pt.text}</span>
                        </div>
                      </li>
                    ))}
                  </ul>
                  ...
                  <div className="rounded-lg border border-danger/18 bg-danger/6 px-3 py-2">
                    ...
                    <p className="text-[0.65rem] text-text-dim">{cat.sanction}</p>
                  </div>
                </div>
              </GlassCard>
            );

    ...
    <>
      <div className="neu-grid neu-grid-2 mx-auto max-w-4xl">
        ...
        <GlassCard className="p-6" data-aos="fade-up" data-aos-duration="500">
          ...
          {/* Live Preview */}
          <div className="mb-6 rounded-[var(--radius-neu-lg)] bg-[#fff8f0] p-4 text-center shadow-[var(--neu-in)]">
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center gap-3">
              <input type="color" aria-label="Pilih warna prefix" value={prefixColor} onChange={(e) => setPrefixColor(e.target.value)} className="h-12 w-14 shrink-0 cursor-pointer rounded-[var(--radius-neu)] border-0 bg-[#fff8f0] p-1.5 shadow-[var(--neu-in)]" />
        ...
        <GlassCard className="flex flex-col items-center gap-5 p-6" data-aos="fade-up" data-aos-duration="500">
          ...
          <img src={customPrefixImg} alt="Contoh Custom Prefix in-game" className="max-w-full rounded-[var(--radius-neu-lg)] shadow-[var(--neu-out)]" />
